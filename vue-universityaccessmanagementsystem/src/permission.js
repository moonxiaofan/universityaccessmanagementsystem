    ...
    axios
        ...
        .then((res) => {
          if(res.data.result == "success") {
            ...
            let getUserId =  res.data.user.id
            localStorage.setItem('userId', getUserId)
            let getUserName =  res.data.user.name
            localStorage.setItem('userName', getUserName)
            let getUserAcademyId = res.data.user.academyId
            localStorage.setItem('academyId', getUserAcademyId)
          }
        })
  }
  // 取到用户的角色
